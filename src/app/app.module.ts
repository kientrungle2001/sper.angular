...
import { SperServiceDetailComponent } from './modules/sper/service/detail/detail.component';
...
@NgModule({
  declarations: [
    ...
    SperServiceDetailComponent,
    SperPageNewsComponent,
    SperPageNewsDetailComponent,
    SperPageServiceDetailComponent
  ],
  imports: [
    BrowserModule,
    AppRoutingModule
